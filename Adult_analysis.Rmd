...
a1$J12_J18_prim <- 0
a1$J12_J18_prim[substr(a1$icd1,1,3) %in% c('J12','J13','J14','J15','J16','J17','J18')] <- 1
...
Number of deaths due to pneumonia (primary)

```{r}
a2 <- a1 %>%
  group_by(agec,monthdate) %>%
  summarise('J12_J18_prim'=sum(J12_J18_prim), 'acm_noj'=sum(acm_noj))
```
